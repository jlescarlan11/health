...
exports.resolveServiceAlias = exports.VALID_SERVICES = void 0;
...
const resolveServiceAlias = (service) => {
    ...
    if (s.includes('vaccine') || s.includes('vax') || s.includes('shot') || s.includes('immuniz'))
        return 'Immunization';
    if (s.includes('emergency') || s.includes('er') || s.includes('urgent'))
        return 'Emergency';
    if (s.includes('checkup') || s.includes('general') || s.includes('routine'))
        return 'General Medicine';
    if (s.includes('adolescent') || s.includes('teen'))
        return 'Adolescent Health';
    if (s.includes('ob') || s.includes('gyne') || s.includes('women health'))
        return 'OB-GYN';
...
exports.resolveServiceAlias = resolveServiceAlias;
