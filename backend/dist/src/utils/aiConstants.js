...
exports.DEFAULT_RED_FLAG_QUESTION = exports.REFINE_QUESTION_PROMPT = exports.BRIDGE_PROMPT = exports.IMMEDIATE_FOLLOW_UP_PROMPT = exports.RECOMMENDATION_NARRATIVE_PROMPT = exports.SYMPTOM_ASSESSMENT_SYSTEM_PROMPT = exports.REFINE_PLAN_PROMPT = exports.FINAL_SLOT_EXTRACTION_PROMPT = exports.GENERATE_ASSESSMENT_QUESTIONS_PROMPT = exports.VALID_SERVICES = exports.DYNAMIC_CLARIFIER_PROMPT_TEMPLATE = exports.SHARED_MEDICAL_CONTEXT = void 0;
exports.SHARED_MEDICAL_CONTEXT = `You are a medical triage AI for Naga City, Philippines.
Always output valid JSON without markdown formatting.
Safety is paramount: red flag assessment is mandatory.`;
exports.DYNAMIC_CLARIFIER_PROMPT_TEMPLATE = `
${exports.SHARED_MEDICAL_CONTEXT}
...
- Turn floor status: {{currentTurn}} completed turns; simple cases need 2 turns, complex/critical/vulnerable cases need 3 turns. Category: {{categoryLabel}}

Instructions:
1. Review the "Established Clinical Facts" and "Recent user replies" carefully to ensure relevant questions, but DO NOT explicitly reference them in the question text (e.g., avoid "Since you have..."). Just ask the question.
...
2. Respect the minimum-turn floors. Simple cases require at least 2 turns and complex/critical/vulnerable cases need 3 turns before termination is allowed. Do not treat these guardrails as optional.
...
exports.GENERATE_ASSESSMENT_QUESTIONS_PROMPT = `
${exports.SHARED_MEDICAL_CONTEXT}
...
`;
exports.FINAL_SLOT_EXTRACTION_PROMPT = `
${exports.SHARED_MEDICAL_CONTEXT}
...
1. **Strict Extraction**: Only extract info explicitly provided. Missing info = null.
   - For specialized cases (e.g., fever, chest pain), also extract relevant findings into the "specific_details" object using clear keys (e.g., "fever_max_temp", "radiation").
...
`;
exports.SYMPTOM_ASSESSMENT_SYSTEM_PROMPT = `
${exports.SHARED_MEDICAL_CONTEXT}
...
When the conversation history contains the [RECENT_RESOLVED] tag, this indicates a critical symptom that occurred recently but has since stopped. You MUST gather detailed temporal information about this event.
...
`;
exports.RECOMMENDATION_NARRATIVE_PROMPT = `
${exports.SHARED_MEDICAL_CONTEXT}
...
STRICT OUTPUT REQUIREMENTS:
- PROHIBIT ALL markdown formatting, backticks, code fences (e.g., no code blocks), and conversational filler.
...
`;
exports.IMMEDIATE_FOLLOW_UP_PROMPT = `
${exports.SHARED_MEDICAL_CONTEXT}
...
`;
exports.REFINE_QUESTION_PROMPT = `Refine this question: '{{questionText}}'. Ensure it flows naturally from the last answer: '{{userAnswer}}', but DO NOT repeat the answer or explain the connection. Just ask the question directly.`;
exports.DEFAULT_RED_FLAG_QUESTION = {
    id: 'red_flags',
    type: 'multi-select',
    ...
    options: [
        {
            ...
            items: ['Chest Pain', 'Difficulty Breathing', 'Confusion', 'None'],
        },
    ],
    tier: 1,
    is_red_flag: true,
};
//# sourceMappingURL=aiConstants.js.map