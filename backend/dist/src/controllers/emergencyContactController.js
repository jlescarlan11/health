...
exports.listEmergencyContactsByCategory = exports.listEmergencyContacts = void 0;
const emergencyContactService = __importStar(require("../services/emergencyContactService"));
const listEmergencyContacts = async (_req, res) => {
    try {
...
const listEmergencyContactsByCategory = async (req, res) => {
    try {
...
exports.listEmergencyContactsByCategory = listEmergencyContactsByCategory;
