...
- **Local Emergency Guard (`src/services/emergencyDetector.ts`):**
  - **Keyword System:** Scans for 100+ keywords in English and **Bicolano** (e.g., _hingalo_, _kulog sa daghan_, _nagkukumbulsion_).
...
- **The "Hospital Floor" Safety Protocol:** If a high-risk symptom (like slurred speech) is reported as _recently resolved_, the app prevents a "Self-Care" recommendation and enforces a "Hospital" visit to rule out transient crises.
