...
export const FacilityDirectoryLogo: React.FC<FacilityDirectoryLogoProps> = ({ width = 28, height = 28, style }) => {
  return (
    <Svg
      width={width}
      height={height}
    ...
    >
      <Defs>
        ...
        <ClipPath id="c888c93828">
          <Path d="M 187.5 0 C 83.945312 0 0 83.945312 0 187.5 C 0 291.054688 83.945312 375 187.5 375 C 291.054688 375 375 291.054688 375 187.5 C 375 83.945312 291.054688 0 187.5 0 Z M 187.5 0 " clipRule="nonzero" />
        </ClipPath>
        ...
        <ClipPath id="cba0323842">
          <Path d="M 104 67.0625 L 271 67.0625 L 271 308 L 104 308 Z M 104 67.0625 " clipRule="nonzero" />
        </ClipPath>
