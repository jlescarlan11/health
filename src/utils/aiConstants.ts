...
export const SHARED_MEDICAL_CONTEXT = `You are a medical triage AI for Naga City, Philippines.
...
export const RECOMMENDATION_NARRATIVE_PROMPT = `
${SHARED_MEDICAL_CONTEXT}
...
export const DEFAULT_RED_FLAG_QUESTION = {
  id: 'red_flags',
  type: 'multi-select',
